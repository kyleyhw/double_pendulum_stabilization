...
def run_simulation(model_path=None, duration=20.0, wind_std=0.0, save_mp4=False, output_mp4="docs/images/final_run.mp4", reset_mode="down", headless=False):
    """
...
if __name__ == "__main__":
    ...
    run_simulation(model_path=args.model, duration=args.duration, wind_std=args.wind, save_mp4=args.save_mp4, output_mp4=args.output, reset_mode=args.reset_mode, headless=args.headless)
